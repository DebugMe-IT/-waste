  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem} onPress={() => handleTabPress("Home", "/homeScreen")}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => handleTabPress("Marketplace", "/marketplace")}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => handleTabPress("Schedule","/SchedulePickupScreen")}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => handleTabPress("Profile", "/profile")}>
